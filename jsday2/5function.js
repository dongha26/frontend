...
result = myfunc1();         // 인자값이 없음 -> 리턴값계산못함 -> 리턴 NaN(not a number)
console.log('result : ' + result);
...
myfunc5(999);
console.log(myfunc5(999));     
//자바에서는 리턴값이 없는 메소드를 리턴값을 받아서 저장/출력하려고 하면 오류
//자바스크립트에서는 오류없이 undefined입니다 myfunc5 실행 그 후 리턴값이 없으므로 undefined 출력
